const {
  ...
  ensureStudioWebhookOnConversation,
...
exports.sendOutboundMessageAndWaitForReply = async (
  ...
  // Point a webhook at studio to handle replies from customer. On a reused
  // conversation we still check — if the original was created through the
  // Interactions API (OPEN_CHAT mode) it has no Studio webhook and replies
  // would otherwise be dropped.
  await ensureStudioWebhookOnConversation(
    client,
    conversation,
    InboundStudioFlow
  );
